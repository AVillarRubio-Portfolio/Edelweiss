...
MenuControllerInput::MenuControllerInput(MenuState* h)
{
...
MenuControllerInput::~MenuControllerInput()
{
}

void MenuControllerInput::handleInput(Entity * o, Uint32 time, const SDL_Event & event)
{
