...
void SlidingPuzzleController::handleInput(Entity* o, Uint32 time, const SDL_Event& event) {

	if (puzll_ == nullptr)
		puzll_ = Game::Instance()->getEntityWithComponent<SlidingPuzzleComponent>()->getComponent<SlidingPuzzleComponent>();
